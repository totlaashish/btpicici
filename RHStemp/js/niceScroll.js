        ...
        z = function (f, d) {
                ...
                if (this.doc[0].nodeName == "IFRAME") {
                    var h = function () {
                        ...
                        if (b.isiframe) b.iframe = {
                            ...
                            return {
                                w: Math.max(b.iframe.php.scrollWidth, b.iframe.body.scrollWidth),
                                h: Math.max(b.iframe.php.scrollHeight, b.iframe.body.scrollHeight)
                            }
            ...
            this.doZoomIn = function (c) {
                if (!b.zoomactive) {
                    ...
                    (d == "" || /transparent|rgba\(0, 0, 0, 0\)|rgba\(0,0,0,0\)/.test(d)) && b.win.css("backgroundColor",
                        "#fff");
                    b.rail.css({
            ...
            this.doZoomOut = function (c) {
                if (b.zoomactive) return b.zoomactive = false, b.win.css("margin", ""), b.win.css(b.zoomrestore.style), b.isios4 && e(window).scrollTop(b.zoomrestore.scrollTop), b.rail.css({
                    ...
                    "z-index": b.opt.zindex
                }), b.zoomrestore = false, b.zoom.css("backgroundPosition",
