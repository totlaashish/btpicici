	...
	var strUser = document.getElementById("calculateDrpDwn").value; 
	 switch(strUser){
		case "Home Loan Eligibility":
				opennewsletter('','http://www.icicibank.com/nri-banking/eligibility-calculator.html','537px','500px','background-image:url()','../images/close.png');
				break;
		case "Loan EMI":
				opennewsletter('','http://www.icicibank.com/nri-banking/emi-calculator.html','520px','390px','background-image:url()','../images/close.png');
				break;
	...
	var strUser = document.getElementById("nearestDrpDwn").value; 
	 switch(strUser){
		...
		case "Draft Locations":
				location.href ="http://www.icicibank.com/nri-banking/RHStemp/draftLocation.html";
				break;
		case "P O Box":
				location.href ="http://www.icicibank.com/nri-banking/RHStemp/poBox.html";
				break;
  }	
}
...
function interestrat(){
	var strUser = document.getElementById("interestrateDrpDwn").value; 
	 switch(strUser){
		case "NRE Savings":
				location.href ="http://www.icicibank.com/nri-banking/RHStemp/rates.html#T-4";
				break;
		case "NRO Savings":
				location.href ="http://www.icicibank.com/nri-banking/RHStemp/rates.html#T-2";
				break;
		case "NRE Fixed Deposit":
				location.href ="http://www.icicibank.com/nri-banking/RHStemp/rates.html#T-3";
				break;
		case "NRO Fixed Deposit":
				location.href ="http://www.icicibank.com/nri-banking/RHStemp/rates.html";
				break;
		case "RFC Savings":
				location.href ="http://www.icicibank.com/nri-banking/RHStemp/rates.html#T-7";
				break;
		case "RFC Fixed Deposit":
				location.href ="http://www.icicibank.com/nri-banking/RHStemp/rates.html#T-6";
				break;
		case "FCNR Deposit":
				location.href ="http://www.icicibank.com/nri-banking/RHStemp/rates.html#T-5";
				break;
		case "OBU Deposit":
				location.href ="http://www.icicibank.com/nri-banking/RHStemp/obu_rates.html";
				break;
	}	
}
...
function changepopup(img_name,div_name)
   {
	   ...
	   {
		    document.getElementById(img_name).src ="images/downarrowPopup.html";
