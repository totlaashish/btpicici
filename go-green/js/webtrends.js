...
// Created: 9/19/2013 7:17:28 AM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcswwac8g000004zlvna6datz_1n7h";
	this.domain="sdc.icicibank.com";
	this.timezone=5.5;
	this.onsitedoms="";
	...
	if (evt&&((typeof(evt.which)!="number")||(evt.which==1))){
		...
		if (e.href){
		    ...
		    if (this.dcsIsOnsite(hn)&&this.dcsTypeMatch(e.pathname,this.downloadtypes)){
		        ...
		        var pth=e.pathname?((e.pathname.indexOf("http://www.icicibank.com/")!=0)?"/"+e.pathname:e.pathname):"/";
		        var ttl="";
...
WebTrends.prototype.dcsDebug=function(){
	...
	var q=i.indexOf("?");
	var r=i.substring(0,q).split("http://www.icicibank.com/");
